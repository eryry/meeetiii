...
(103, 3, 'ao', 'あおさんです。', 0, '2020-09-23 13:56:07'),
(104, 3, 'ume', '画像枠線テストです！', 0, '2020-09-23 15:22:26'),
(105, 5, 'nobita', 'しずかちゃんが、こんなヘアスタイル可能かどうか知りたいそうです！\r\nヘア小物は、自分で用意する予定です。', 1, '2020-09-24 13:31:21'),
(106, 5, 'nobita', 'あと、掛下をプラン内のものから、ランクアッププランの、こちらの色掛下に変更したいのすが、おいくらでしたか？？', 1, '2020-09-24 13:32:14'),
(107, 10, 'azusa', '犬と一緒に撮影できますか？', 1, '2020-09-24 13:42:03'),
(108, 10, 'azusa', 'おとなしい犬です。', 1, '2020-09-24 13:42:27'),
(109, 10, 'azusa', 'あと、この神社、どこかわかりますか？\r\nこんな写真が撮りたいです！', 1, '2020-09-24 13:43:06'),
(110, 10, 'katoeri', '写真の場所は、随心院（ずいしんいん）さんです。\r\nhttp://www.zuishinin.or.jp/', 0, '2020-09-24 13:44:53'),
(111, 10, 'katoeri', '犬は、うめさんならOKです。', 0, '2020-09-24 13:45:45'),
(112, 9, 'eri', 'この衣装をHPで見たのですが、次回試着の時に見てみたいです！', 1, '2020-09-24 14:21:50'),
(113, 9, 'eri', 'あと、この小物に似たイメージのものは取り扱っていますか？', 1, '2020-09-24 14:22:19'),
(114, 19, 'mickey', 'ぼくみっきー！', 0, '2020-09-24 15:19:45');
...
('eri', 9, 'えみ', '$2y$10$assTB6p8jr3ihxZrcosONOpYW8UVRNHUdNsYUvkrZz0SJn84E44/e', 'emi@emiemi.com', '000', '6020802', '', 1, 1),
...
('mickey', 19, 'ミッキー', '$2y$10$U5j0m/g5l7o3ySiczLkPeOywUdRdXhrZ.AoUMa32/QtxRnoVLv2Om', '', '', '', '夢の国', 0, 0),
('minnie', 19, 'ミニー', '$2y$10$ADohWAd6hO.KMahW0AaeD./6EqBk5GIyc/5xKNw7IqVIWah8Im/2K', '', '', '', '', 1, 0),
...
(5, 5, '2020-09-25', '14:30:00', 1, 1, 1, 0, '6038451', '京都府京都市北区衣笠鏡石町1－12', 0, 0, 1, 1, 0, 'yasuda', 1),
...
(12, 9, '2020-09-21', '11:30:00', 1, 1, 0, 0, '5860000', '大阪府河内長野市', 1, 1, 1, 1, 1, 'katoeri', 1),
(19, 11, '2020-10-02', '10:00:00', 0, 0, 1, 0, '', '', 1, 1, 0, 1, 1, 'katoeri', 1),
...
--
ALTER TABLE `board`
  MODIFY `b_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- テーブルのAUTO_INCREMENT `list`
--
ALTER TABLE `list`
  MODIFY `list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

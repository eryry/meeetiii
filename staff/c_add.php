		...
		<main>
			...
			<section>
				<form action="exec_c_add.php" method="post" autocomplete="off">
					<table>
						<tr>
							<th><label for="c_group_id">グループID </label><span class="required_color">必須</span></th>
							<td>
						...
						<tr>
							<th><label for="c_id">顧客ID</label><span class="required_color">必須</span></th>
							<td><input type="text" name="c_id" id="c_id" placeholder="*半角数字/半角アルファベット"></td>
						</tr>
						<tr>
							<th><label for="c_name">名前</label><span class="required_color">必須</span></th>
							<td><input type="text" name="c_name" id="c_name"></td>
						</tr>
						<tr>
							<th><label for="c_pass">パスワード</label><span class="required_color">必須</span></th>
							<td>
								<p class="pass_area">
